...
# docker build -t casmitter .
# docker run -d -p 80:80 -e RAILS_MASTER_KEY=<value from config/master.key> --name casmitter casmitter
...
# Install packages needed to build gems including PostgreSQL development libraries
RUN apt-get update -qq && \
